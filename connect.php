				 ...
				 <div class="col-lg-4 col-md-4 col-sm-12">
					...
					<form action="contact.php" method="POST" style=" padding: 5px; border-radius: 15px;">
                        ...
                        <?php 
                            ...
                            if (isset($_POST['prenom']) && isset($_POST['email']) && isset($_POST['tel']) && isset($_POST['message'])) {
                                ...
                                $requette="INSERT INTO `contactez` (`id`, `prenom`, `email`, `tel`, `message`) VALUES (NULL, '$prenom', '$email', '$tel', '$message');";
