					...
					<form action="contact.php" method="POST" style=" padding: 5px; border-radius: 15px;">
						   <fieldset>
						       <div class="full field">
							      <input type="text" placeholder="Votre Nom" name="prenom" style="margin-bottom: 0px; outline: none;" />
							   ...
							   <div class="full field" >
							      <textarea placeholder="Message" name="message" style="margin-bottom: 0px; outline: none;"></textarea>
								  <div style="width: 100%; height: 4px; background-image: linear-gradient(to right, #002247, #bde1e5); margin-top: 0;"></div>
							   </div>
							   <div class="full field">
							      <div class="center"><input type="submit" value="Contact" style="margin-bottom: 0px; outline: none;"></div>
								  <div style="width: 100%; height: 4px; background-image: linear-gradient(to right, #002247, #bde1e5); margin-top: 0;"></div>
							   </div>
						   </fieldset>
						</form>
